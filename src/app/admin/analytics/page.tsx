        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-medium text-gray-500 truncate">Downloads Today</dt>
                  <dd className="text-2xl font-semibold text-gray-900">12.4K</dd>
                </dl>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd className="text-2xl font-semibold text-gray-900">4.6</dd>
                </dl>
              </div>
            </div>
          </div>
      ...
      <div className="bg-white shadow rounded-lg">
        <div className="px-4 py-5 sm:p-6">
          ...
          <div className="text-center py-12">
            ...
            <p className="mt-1 text-sm text-gray-500">Detailed analytics and charts will be available here.</p>
          </div>
        </div>
      </div>
    </div>
